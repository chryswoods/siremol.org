...
This workshops assumes you have knowledge of R equivalent to that covered
...
1. [Tidy data](tidyverse.html)
2. [tibbles and filters](tibbles.html)
3. [Reading from a file](files.html)
4. [Mapping and transforms](mapping.html)
5. [Plotting data](ggplot.html)
6. [Making it prettier](prettier.html)
...
[markdown](https://www.markdownguide.org/getting-started/). This is a simple
