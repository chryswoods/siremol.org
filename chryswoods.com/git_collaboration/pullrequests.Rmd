...
However, pushing changes to someone elses repository is considered rude. Normally you don't have
permission to push to someone else's repository, e.g. if you type `git push upstream main`
you should see an error saying that you are unable to access the repositry.
