...
1. [String formatting](formatting.html) - includes stringr
2. [Packages and CRAN](packages.html) - what was installing stringr, what is CRAN
3. [Functions](functions.html) - how to write a function, how to add docs, how to signal error
4. [Tidyverse](tidyverse.html) - collection of good packages - modern R
5. [`%>%` Forward pipe](magrittr.html)
7. [Output](output.html)
