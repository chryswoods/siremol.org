...
as the mean average of the heart weight of female cats whose
body weight is greater than 2.5.
...
Note that `average_heart_weight` is a 1x1 `tibble`. You can extract
